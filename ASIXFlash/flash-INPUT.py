...
# Duran Keeley
# Input MAC ADDRESS (req:easygui)
import easygui
NEW_MAC_ADDRESS = easygui.enterbox("MAC ADDRESS")

import re
NEW_MAC_ADDRESS = re.sub(" ",'',NEW_MAC_ADDRESS)
NEW_MAC_ADDRESS = re.sub(":",'',NEW_MAC_ADDRESS)
NEW_MAC_ADDRESS = re.sub("-",'',NEW_MAC_ADDRESS)

# Duran Keeley
# Backup EEPROM with current time and date
